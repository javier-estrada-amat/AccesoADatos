...
public class EmpleadoDAO {
    ...
    public void obtenerEmpleadoMes(int numero) throws SQLException{
        ...
        preparedStatement = connection.prepareStatement(
                String.format(query,SchemaDB.TAB_EMP,SchemaDB.COL_EMP_SALE));
    ...
    public void realizarVenta(int id) throws SQLException{
        ...
        preparedStatement = connection.prepareStatement(
                String.format(query,SchemaDB.TAB_EMP, SchemaDB.COL_EMP_SALE, SchemaDB.COL_ID));
    ...
    public void insertarEmpleado(Empleado empleado) throws SQLException {
        ...
        //connection
        // Para hacer la insercion usamos un prepare statement
    ...
    public Empleado getEmpleado(int id) throws SQLException {
        preparedStatement = connection.prepareStatement(String.format("SELECT * FROM %s WHERE %s=?",
                SchemaDB.TAB_EMP, SchemaDB.COL_ID
        ));
