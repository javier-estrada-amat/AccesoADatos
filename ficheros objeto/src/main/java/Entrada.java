...
public class Entrada {
    ...
    public static void main(String[] args) {
      ...
      //  gestorFicheros.escribirObjeto("src/main/java/resources/objetosserializados.obj");

        gestorFicheros.lecturaObjeto("src/main/java/resources/objetosserializados.obj");
